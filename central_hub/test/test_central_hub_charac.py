...
class TestCentralHubBehavior:
    ...
    def setup_method(self):
        ...
        sensor_types = [
            "thermometer", "ecg", "oximeter", 
            "abps", "abpd", "glucosemeter"
        ]
    ...
    def test_receive_datapoint(self):
        ...
        self.publish_sensor_data('thermometer', test_value, test_risk_level, test_risk_percentage)
    ...
    def test_data_fusion_algorithm(self):
        ...
        assert 35.0 <= patient_status <= 55.0, f"Expected around 50.0, got {patient_status}"
    ...
    def test_blood_pressure_special_handling(self):
        ...
        if len(self.received_messages) == 0:
            ...
            assert patient_status > 10.0, f"Patient status with high BP: {patient_status}"
            return
    ...
    def test_full_system_integration(self):
        ...
        assert len(self.received_messages) >= 2, "Did not receive message after condition change"
        ...
        assert last_msg.patient_status > baseline_status, \
    ...
    def test_data_fusion_with_deviation_weighting(self):
        ...
        abp_avg = (self.central_hub.latest_risk["abps"] + self.central_hub.latest_risk["abpd"]) / 2
        assert abp_avg == 80.0
